...
export type PluginRuntimeChannel = {
  ...
  /** iMessage channel support removed in hive-gateway. */
  imessage: Record<string, never>;
  /** WhatsApp channel support removed in hive-gateway. */
  whatsapp: Record<string, never>;
  /** LINE channel support removed in hive-gateway. */
